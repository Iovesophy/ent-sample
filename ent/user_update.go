...
func (uu *UserUpdate) SetUserType(i int32) *UserUpdate {
...
func (uu *UserUpdate) AddUserType(i int32) *UserUpdate {
...
func (uu *UserUpdate) check() error {
	if v, ok := uu.mutation.UserType(); ok {
		if err := user.UserTypeValidator(v); err != nil {
			return &ValidationError{Name: "userType", err: fmt.Errorf("ent: validator failed for field \"userType\": %w", err)}
		}
	}
	if v, ok := uu.mutation.PasswordHash(); ok {
		if err := user.PasswordHashValidator(v); err != nil {
			return &ValidationError{Name: "passwordHash", err: fmt.Errorf("ent: validator failed for field \"passwordHash\": %w", err)}
		}
	}
	return nil
}
...
// SetUserType sets the "userType" field.
func (uuo *UserUpdateOne) SetUserType(i int32) *UserUpdateOne {
...
// AddUserType adds i to the "userType" field.
func (uuo *UserUpdateOne) AddUserType(i int32) *UserUpdateOne {
